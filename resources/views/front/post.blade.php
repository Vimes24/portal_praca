...
@section('main_title'){{ $post_single->title }}@endsection
@section('main_description'){{ $post_single->meta_description}} @endsection

@section('main_content')
<div class="page-top" style="background-image: url('{{ asset('uploads/'.$global_banner_data->baner_post) }}')">
    <div class="bg"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
...
{{-- skrypt poniżej dodaje połączenie z aplikacjami mobilnymi jak Twitter czy FB wyskakującymi z lewej strony ekranu --}}
<script
