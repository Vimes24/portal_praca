...
@section('main_title'){{ $home_page_data->title }}@endsection
@section('main_description'){{ $home_page_data->description}} @endsection
                            ...
                            <div class="inner">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <select
                                                name="location" class="form-select select2">
                                                <option value="">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="heading">
                    ...
                    <p>
                        {{ $home_page_data->job_category_text }}
                    </p>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="item">
                    ...
                    <h3>{{ $item->name }}</h3>
                    {{-- r_job_count z relacji hasMany w modelu JobCategory i funkcji withCount --}}
                    <p>({{ $item->r_job_count }} ofert łącznie)</p>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="heading">
                    ...
                    <p>
                        {{ $home_page_data->why_choose_text }}
                    </p>
                </div>
            </div>
        </div>
...
<div class="job">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="heading">
                    ...
                    <p>{{ $home_page_data->featured_jobs_text }}</p>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="all">
                    <a href="{{ route('job_listing') }}" class="btn btn-primary">Zobacz wszystkie oferty</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="item">
                    ...
                    <div class="text">
                        ...
                        <div class="button">
                            <a href="{{ route('post', $item->slug) }}" class="btn btn-primary">Czytaj więcej</a>
                        </div>
                    </div>
                </div>
            </div>
