                    ...
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $i }}">List motywacyjny</a></td>
                                <td>
