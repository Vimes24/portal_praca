...
@section('heading', 'Aplikujący do oferty: '.$job_detail->title)
                        ...
                        <table class="table table-bordered" id="example1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin_companies_applicant_resume',$item->candidate_id) }}" class="badge bg-primary text-white" target="_blank">Szczegóły</a>
                                    </td>
                                    <td>
