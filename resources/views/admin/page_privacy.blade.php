                ...
                <div class="card-body">
                    <form action="{{ route('admin_privacy_page_update') }}" method="post">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="heading" value="{{ $page_privacy_data->heading }}">
                        </div>
                        <div class="form-group mb-3">
                            <label>Treść *</label>
                        ...
                        <div class="form-group mb-3">
                            <label>Tytuł</label>
                            <input type="text" class="form-control" name="title" value="{{ $page_privacy_data->title }}">
                        </div>
                        <div class="form-group mb-3">
                            <label>Opis</label>
                            <textarea name="description" class="form-control editor" cols="30" rows="10">{{ $page_privacy_data->description }}</textarea>
                        </div>
