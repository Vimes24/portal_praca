                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                <input type="text" name="video_id" class="form-control" placeholder="Wpisz kod filmu"/>                                
                            </div>
                        </div>
                    </div>
                ...
                <div class="video-all">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3">
                            ...
                            <a href="{{ route('company_videos_delete', $item->id) }}" class="btn btn-danger btn-sm mb-4" onClick="return confirm('Jesteś pewny?')">Usuń</a>
                        </div>
                        @endforeach
                    </div>
                </div>
