...
class AdminJobLocationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin_job_location')->with('success', 'Pomyślnie zapisano informacje.');
    ...
    public function update (Request $request, $id)
    {
        ...
        return redirect()->route('admin_job_location')->with('success', 'Pomyślnie zaktualizowano informacje.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('admin_job_location')->with('success', 'Pomyślnie usunięto informacje.');
    }
}
