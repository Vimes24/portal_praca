...
class AdminWhyChooseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin_why_choose_item')->with('success', 'Pomyślnie zapisano informacje.');
    }
    ...
    public function update (Request $request, $id)
    {
        ...
        return redirect()->route('admin_why_choose_item')->with('success', 'Pomyślnie zaktualizowano informacje.');
    }

    public function delete($id)
    {
        WhyChooseItem::where('id', $id)->delete();
        return redirect()->route('admin_why_choose_item')->with('success', 'Pomyślnie usunięto informacje.');
    }
}
