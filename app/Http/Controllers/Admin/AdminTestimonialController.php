...
class AdminTestimonialController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin_testimonial')->with('success', 'Pomyślnie zapisano informacje.');
    }
    ...
    public function update (Request $request, $id)
    {
        ...
        return redirect()->route('admin_testimonial')->with('success', 'Pomyślnie zaktualizowano informacje.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('admin_testimonial')->with('success', 'Pomyślnie usunięto informacje.');
    }
}
