...
class AdminOtherPageController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $other_page_data->login_page_description = $request->login_page_description;
        ...
        $other_page_data->signup_page_description = $request->signup_page_description;
        $other_page_data->forget_page_heading = $request->forget_page_heading;
        $other_page_data->forget_page_title = $request->forget_page_title;
        $other_page_data->forget_page_description = $request->forget_page_description;
        ...
        $other_page_data->job_listing_page_description = $request->job_listing_page_description;
        ...
        $other_page_data->company_listing_page_description = $request->company_listing_page_description;
