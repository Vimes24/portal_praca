...
class CompanyListingController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('front.company_listing', compact('companies', 'company_industries',
        'company_locations', 'form_name', 'form_industry', 'form_location',
        'company_sizes', 'form_size', 'form_founded', 'other_page_item'));
    }
    ...
    public function detail($id)
    {
        ...
        $company_single = Company::withCount('rJob')->with('rCompanyIndustry', 'rCompanyLocation',
        'rCompanySize')->where('id', $id)->first();
        ...
        'rJobType', 'rJobExperience', 'rJobGender', 'rJobSalary')->where('company_id', $company_single->id)->get();
    ...
    public function send_email (Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Pomyślnie wysłano email.');
    }
}
