...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('page_other_items', function (Blueprint $table) {
            ...
            $table->text('login_page_description')->nullable();
            $table->text('signup_page_heading');
            $table->text('signup_page_title')->nullable();
            $table->text('signup_page_description')->nullable();
            $table->text('forget_page_heading');
            $table->text('forget_page_title')->nullable();
            $table->text('forget_page_description')->nullable();
            $table->text('job_listing_page_heading');
            $table->text('job_listing_page_title')->nullable();
            $table->text('job_listing_page_description')->nullable();
            $table->text('company_listing_page_heading');
            $table->text('company_listing_page_title')->nullable();
            $table->text('company_listing_page_description')->nullable();
