...
/* utworzenie grupy ścieżek z ograniczeniem dostępu tylko dla zalogowanej instytucji */
Route::middleware(['company:company'])->group(function () {
    ...
    Route::get('/company/applicant-detail/{id}', [CompanyController::class, 'applicant_detail'])->name('company_applicant_detail');
...
/* utworzenie grupy ścieżek z ograniczeniem dostępu tylko dla zalogowanego kandydata */
Route::middleware(['candidate:candidate'])->group(function () {
    ...
    Route::get('/candidate/skills/view', [CandidateController::class, 'skills'])->name('candidate_skills');
    Route::get('/candidate/skills/create', [CandidateController::class, 'skills_create'])->name('candidate_skills_create');
    Route::post('/candidate/skills/store', [CandidateController::class, 'skills_store'])->name('candidate_skills_store');
    Route::get('/candidate/skills/edit/{id}', [CandidateController::class, 'skills_edit'])->name('candidate_skills_edit');
    Route::post('/candidate/skills/update/{id}', [CandidateController::class, 'skills_update'])->name('candidate_skills_update');
    Route::get('/candidate/skills/delete/{id}', [CandidateController::class, 'skills_delete'])->name('candidate_skills_delete');
...
/* utworzenie grupy ścieżek z ograniczeniem dostępu tylko dla zalogowanego administratora */
